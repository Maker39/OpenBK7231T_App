...
void Test_Events() {
	...
	SELFTEST_ASSERT(EVENT_ParseEventName("On6Click") == CMD_EVENT_PIN_ON6CLICK);
	SELFTEST_ASSERT(EVENT_ParseEventName("On7Click") == CMD_EVENT_PIN_ON7CLICK);
	SELFTEST_ASSERT(EVENT_ParseEventName("On8Click") == CMD_EVENT_PIN_ON8CLICK);
	SELFTEST_ASSERT(EVENT_ParseEventName("On9Click") == CMD_EVENT_PIN_ON9CLICK);
	SELFTEST_ASSERT(EVENT_ParseEventName("On10Click") == CMD_EVENT_PIN_ON10CLICK);
